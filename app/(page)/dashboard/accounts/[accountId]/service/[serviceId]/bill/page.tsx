...
export default async function ServiceBill({ params }: { accountId: string, params: { serviceId: string } }) {
  ...
  return (
    <article className="dashboard-content-container gap-7 xl:py-16">
      ...
      <div className='bg-my-black p-10 flex flex-col gap-8 pb-28 rounded-xl relative sm:p-12 sm:pb-20 xl:p-16 xl:pb-12'>

        <form action={submitAction}>
          <h2 className='text-3xl font-bold tracking-widest text-primary pb-8 w-[70%] sm:w-full sm:text-4xl sm:pb-28 xl:text-3xl xl:pb-12'>Número de cuenta sin el primer 2</h2>
          <input className='input-form w-full h-20 sm:h-28 xl:w-1/2 xl:h-24' type="text" name={'billNumber'} />
          ...
          <div className='w-full absolute flex justify-end sm:relative -bottom-[7.5rem] right-0 sm:bottom-0'>
            ...
            <button className='button-form card-shadow w-1/2 h-20 sm:h-28 sm:w-full sm:mt-6 xl:w-3/12' type="submit">Continuar</button>
