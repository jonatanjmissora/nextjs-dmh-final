  ...
  return (
    <article className="dashboard-content-container gap-7 xl:py-16  xl:gap-0">
      ...
      <div className='bg-my-black p-12 flex flex-col justify-center items-center gap-8 rounded-xl relative sm:gap-12 sm:py-20 xl:p-16'>
        ...
        <p className='text-gray-400 text-lg text-center sm:px-12 sm:text-2xl xl:px-0 xl:w-1/2'>Revisá el dato ingresado. Si es correcto, es posible que la empresa aún no haya cargado tu factura</p>

      </div>

      <div className='w-full flex justify-end'>
        <Link className='button-form card-shadow w-1/2 h-20 sm:h-28 sm:w-full sm:mt-6 xl:w-3/12' href={`/dashboard/accounts/${accountId}/service/${serviceId}/bill`}>Revisar dato</Link>
      </div>
