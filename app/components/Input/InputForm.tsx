...
export const InputForm = ({
  ...
  const inputClassHasValue = isPassword && hasPassword && 'text-5xl py-0 leading-none';
  const inputClassHasValue2 = isPassword2 && hasPassword2 && 'text-5xl py-0 leading-none';
