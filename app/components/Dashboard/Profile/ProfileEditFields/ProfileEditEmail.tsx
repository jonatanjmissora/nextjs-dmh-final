...
import { EmailType, UserDataTypes } from "@/app/types/user.types";
import { emailEditSchema } from "@/app/schema/userEdit.schema";
...
export default function ProfileEditMail({ token, accountId, user, fieldLabel, fieldValue, editing, setEditing }: ProfileEditFieldProps) {
  ...
  const {
    ...
    resolver: yupResolver(emailEditSchema),
  })
